<?php
/**
 * Formulaire pour la modification du compte administrateur
 *
 * @author ASI
 *
 */
class Ademe_Form_Modules_Private_Compte_Administrateur extends Ademe_Form_Form
{
        ...
        */
        ...
        $this->addElement(
            ...
            array(
                ...
                'description'=> 'Laissez vide si vous ne voulez pas modifier votre mot de passe',
                'filters'    => array('StringTrim'),
                'validators' => array(
